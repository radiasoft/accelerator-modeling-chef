...
template Tcoord<double,FNAL::Complex>;
template Tcoord<FNAL::Complex,double>;

// Friend functions
// ... primary double
template std::ostream& operator<<(std::ostream&, const TJet<double,FNAL::Complex>&);
template std::istream& operator>>(std::istream&, TJet<double,FNAL::Complex>&);

// ... primary complex
template std::ostream& operator<<(std::ostream&, const TJet<FNAL::Complex,double>&);
template std::istream& operator>>(std::istream&, TJet<FNAL::Complex,double>&);
