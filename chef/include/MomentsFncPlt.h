...
public:
    ...
    MomentsFncPlt( beamline*, const char* = 0 );
    MomentsFncPlt( BeamlineContext*, const char* = 0 );
    ~MomentsFncPlt();
...
inline void MomentsFncPlt::setErrorStream( ostream* x )
{
  _errorStreamPtr = x;
}

inline void MomentsFncPlt::setOutputStream( ostream* x )
{
  _outputStreamPtr = x;
}
