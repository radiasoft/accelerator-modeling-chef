...
tree<stored_type, node_compare_type>::tree( const tree_type& rhs ) : associative_tree_type(rhs)
{
...
// assignment operator
template<typename stored_type, typename node_compare_type>
tree<stored_type, node_compare_type>& 
tree<stored_type, node_compare_type>::operator = (const tree_type& rhs)
{
...
// swap
template<typename stored_type, typename node_compare_type>
void tree<stored_type, node_compare_type>::swap(tree_type& rhs)
{
	tree_type temp(*this);
