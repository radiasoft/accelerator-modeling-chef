...
const_pre_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>& const_pre_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>::operator ++()
{
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
const_post_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>::const_post_order_descendant_iterator(const tree_category_type* pTop_node_)
{
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
const_post_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>& const_post_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>::operator ++()
{
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
const_level_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>& const_level_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>::operator ++()
{
