...
class const_pre_order_descendant_iterator : public std::iterator<std::bidirectional_iterator_tag, stored_type>
{
public:
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
class pre_order_descendant_iterator : public const_pre_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>
{
public:
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
class const_post_order_descendant_iterator : public std::iterator<std::bidirectional_iterator_tag, stored_type>
{
public:
	// constructors/destructor
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
class post_order_descendant_iterator : public const_post_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>
{
public:
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
class const_level_order_descendant_iterator : public std::iterator<std::forward_iterator_tag, stored_type>
{
public:
	// constructors/destructor
	const_level_order_descendant_iterator() : pTop_node(0), node_depth(0) {}
	// destructor, copy constructor, and assignment operator will be compiler generated correctly
protected:
	explicit const_level_order_descendant_iterator(typename tree_category_type::const_iterator& it_, const tree_category_type* pTop_node_) : it(it_), pTop_node(pTop_node_), node_depth(0) {}
...
template<typename stored_type, typename tree_type, typename container_type, typename tree_category_type>
class level_order_descendant_iterator : public const_level_order_descendant_iterator<stored_type, tree_type, container_type, tree_category_type>
{
public:
