...
template<typename stored_type, typename node_compare_type, typename node_order_compare_type >
struct unique_tree_deref_less;

template<typename stored_type, typename node_compare_type, typename node_order_compare_type>
class const_unique_tree_ordered_iterator : public std::iterator<std::bidirectional_iterator_tag, stored_type>
{
protected:
	// typedefs
...
template<typename stored_type, typename node_compare_type, typename node_order_compare_type>
class unique_tree_ordered_iterator : public const_unique_tree_ordered_iterator<stored_type, node_compare_type, node_order_compare_type>
{
	// typedefs
	typedef unique_tree<stored_type, node_compare_type, node_order_compare_type> tree_type;
	typedef std::multiset<tree_type*, deref_ordered_compare<tree_type, node_order_compare_type> > ordered_container_type;
