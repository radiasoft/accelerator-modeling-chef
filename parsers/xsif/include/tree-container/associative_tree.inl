...
typename associative_tree<stored_type, tree_type, container_type>::iterator 
associative_tree<stored_type, tree_type, container_type>::find(const stored_type& element) 
{
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type>::const_iterator 
associative_tree<stored_type, tree_type, container_type>::find(const stored_type& element) const
{
	tree_type node_obj(element);
...
template< typename stored_type, typename tree_type, typename container_type >
bool associative_tree<stored_type, tree_type, container_type>::
erase(const stored_type& element)
{
	bool erased_nodes = false;
	tree_type node_obj(element); // create search node
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type>::size_type 
associative_tree<stored_type, tree_type, container_type>::count(const stored_type& element) const
{
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type >::iterator
associative_tree<stored_type, tree_type, container_type>::lower_bound(const stored_type& element)
{
	tree_type node_obj(element); // create a search node and search local children
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type >::const_iterator
associative_tree<stored_type, tree_type, container_type>::lower_bound(const stored_type& element) const
{
	tree_type node_obj(element); // create a search node and search local children
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type >::iterator
associative_tree<stored_type, tree_type, container_type>::upper_bound(const stored_type& element)
{
	tree_type node_obj(element); // create a search node and search local children
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type >::const_iterator
associative_tree<stored_type, tree_type, container_type>::upper_bound(const stored_type& element) const
{
	tree_type node_obj(element); // create a search node and search local children
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type>::iterator 
associative_tree<stored_type, tree_type, container_type>::insert(const const_iterator pos, const stored_type& element, tree_type* pParent)
{
	...
	if ( pos == pParent->end()) {
		...
		typename container_type::iterator children_pos = basic_tree_type::children.begin();
...
template< typename stored_type, typename tree_type, typename container_type >
typename associative_tree<stored_type, tree_type, container_type>::iterator 
associative_tree<stored_type, tree_type, container_type>::insert(const const_iterator pos, const tree_type& tree_obj, tree_type* pParent)
{
	// insert current node
...
template< typename stored_type, typename tree_type, typename container_type >
void associative_tree<stored_type, tree_type, container_type>::set(const tree_type& tree_obj, tree_type* pParent)
{
...
// clear()
template< typename stored_type, typename tree_type, typename container_type >
void associative_tree<stored_type, tree_type, container_type>::clear()
{
	iterator it = begin();
...
// erase(iterator)
template< typename stored_type, typename tree_type, typename container_type >
void associative_tree<stored_type, tree_type, container_type>::erase(iterator it) 
{ 
...
template< typename stored_type, typename tree_type, typename container_type >
void associative_tree<stored_type, tree_type, container_type>::erase(iterator it_beg, iterator it_end)
{
	while (it_beg != it_end) {
		erase(it_beg++);
	}
...
// operator ==
template<typename stored_type, typename tree_type, typename container_type>
bool associative_tree<stored_type, tree_type, container_type>::operator == (const associative_tree_type& rhs) const
{
	// check this node
