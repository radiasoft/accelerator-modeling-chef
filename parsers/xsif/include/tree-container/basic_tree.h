...
class basic_tree 
{
	...
	// constructors/destructor
		...
		explicit basic_tree(const stored_type& element);
	...
	// public interface
		...
		size_type max_size() const { return std::numeric_limits<int>(); }
	...
	protected:
		...
		void allocate_stored_type(stored_type*& element_ptr, const stored_type& element) 
			{ element_ptr = stored_type_allocator.allocate(1,0); stored_type_allocator.construct(element_ptr, element); }
