...
template void propagate<LCavityDnstream,    Particle,dnstream>( LCavityDnstream& elm,    Particle& p );
template void propagate<LCavityDnstream, JetParticle,dnstream>( LCavityDnstream& elm, JetParticle& p );
