...
void octupole::Propagator::operator()( octupole& elm, ParticleBunch&  b )
{ 
  BasePropagator<octupole>::operator()(elm,b);
}

//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||

void octupole::Propagator::operator()(  octupole& elm, JetParticleBunch&  b ) 
{ 
  BasePropagator<octupole>::operator()(elm,b);
}
