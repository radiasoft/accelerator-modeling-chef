...
bool    LCavityUpstream::isThin() const
{
  return false;
}
...
bool    LCavityUpstream::isPassive() const
{
  return false;
}
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
bool    LCavityUpstream::isDriftSpace() const
{
  return false;
}
...
bool    LCavityDnstream::isThin() const
{
  return false;
}
...
bool    LCavityDnstream::isPassive() const
{
  return false;
}
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
bool    LCavityDnstream::isDriftSpace() const
{
  return false;
}
