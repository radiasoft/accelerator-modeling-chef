...
void rfcavity::Propagator::operator()( rfcavity& elm, ParticleBunch& b)
{
    elm.bmlnElmnt::propagate(b);
}
...
void thinrfcavity::Propagator::operator()( thinrfcavity& elm, ParticleBunch& b)
{
    elm.bmlnElmnt::propagate(b);
}
