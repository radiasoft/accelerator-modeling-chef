...
marker::Propagator::Propagator::Propagator()
  :BasePropagator()
{}
...
marker::Propagator::Propagator::Propagator(marker const& elm)
  : BasePropagator(elm)
{}
...
marker::Propagator::Propagator::Propagator(marker::Propagator const& p)
  : BasePropagator(p)
{}
...
void marker::Propagator::ctor( BmlnElmnt const& elm ) 
{}
