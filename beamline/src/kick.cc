...
std::pair<ElmPtr,ElmPtr>  vkick::split( double const& pc ) const
...
std::pair<ElmPtr,ElmPtr>  hkick::split( double const& pc ) const
{
...
std::pair<ElmPtr,ElmPtr>  kick::split( double const& pc ) const
{
