...
void wrap_cf_sbend () {
  ...
  .def("getEntryEdgeAngle",       &CF_sbend::getEntryEdgeAngle,return_value_policy<copy_const_reference>() )
  .def("getExitEdgeAngle",        &CF_sbend::getExitEdgeAngle, return_value_policy<copy_const_reference>() )
