...
FFTFunctor<Input_t, Output_t, fft_direction>::FFTFunctorImpl::FFTFunctorImpl( int nsamples, bool measure)
...
template <typename Input_t, typename Output_t, transform_type fft_direction>
FFTFunctor<Input_t, Output_t, fft_direction>::FFTFunctorImpl::FFTFunctorImpl( FFTFunctorImpl const& other)
...
template <typename Input_t, typename Output_t, transform_type fft_direction>
void FFTFunctor<Input_t, Output_t, fft_direction>::FFTFunctorImpl::ctor()
{
...
template <typename Input_t, typename Output_t, transform_type fft_direction>
FFTFunctor<Input_t, Output_t, fft_direction>::FFTFunctorImpl::~FFTFunctorImpl()
{
...
template <typename Input_t, typename Output_t, transform_type fft_direction>
std::vector<Output_t > FFTFunctor<Input_t, Output_t,fft_direction>::FFTFunctorImpl::operator()( std::vector<Input_t> const& lhs )  
{
...
template <typename Input_t, typename Output_t, transform_type fft_direction>
Output_t* FFTFunctor<Input_t, Output_t, fft_direction >::FFTFunctorImpl::operator() ( Input_t* lhs )  
{
