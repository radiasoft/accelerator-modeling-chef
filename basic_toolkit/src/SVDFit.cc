...
double const SVDFit::threshold_ = 1.0e-8;
...
Vector SVDFit::singularValues() const
{
  return xW0_;
}
...
double SVDFit::nullSpaceThreshold() const
{ 
  return limW_; 
}
