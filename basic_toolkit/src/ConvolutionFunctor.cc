...
template<>
ConvolutionFFTPolicy<double>::ConvolutionFFTPolicy( int nsamples, bool measure)
...
template<>
ConvolutionFFTPolicy<std::complex<double> >::ConvolutionFFTPolicy( int nsamples, bool measure)
