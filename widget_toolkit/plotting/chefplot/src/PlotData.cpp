...
PlotData::Chromaticities const& PlotData::getChromaticities() const
{
  return  chrom_;
}
...
void PlotData::setChromaticities(double const& hor, double const& ver)
{
  chrom_ = Chromaticities(hor,ver);
}
