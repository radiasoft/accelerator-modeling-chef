...
class DistributionWidget : public QDialog
{
  ...
  public:
    // Constructors
    DistributionWidget();
    DistributionWidget( ParticleBunch&, QWidget* = 0, const char* = 0, WFlags = 0 );
      // Can be used to fill the ParticleBunch.
    DistributionWidget( beamline&, ParticleBunch&, QWidget* = 0, const char* = 0, WFlags = 0 );
    ...
    enum ParticleType { proton=0, positron };

  private:
    ParticleType     _flavor;
