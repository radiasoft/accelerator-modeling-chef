////////////////////////////////////////////////////////////
// 
// File:          DriftConverterTest.cc
// Author:        Leo Michelotti
// 
// Revision date: Friday. January 15, 2010. (original version)
// 
////////////////////////////////////////////////////////////
// 
// Does DriftConverter work as expected on the simplest
// possible models?
// 
// ( Compare this file with beamline/tests/bendTest_2.cc )
// (               and with d2sTest_1.cc.                )
// 
// ------------
// COMMAND LINE
// ------------
// DriftConverterTest [options]
// 
// -------
// OPTIONS
// -------
...
int main( int argc, char** argv )
{
  ...
  try {
    ...
    newlinePtr = armando.convert( testline );
  }
  catch( GenericException const& ge ) {
    cout << __FILE__ << "," << __LINE__ << ": Exception thrown by DriftConverter" << endl;
    cout << ge.what() << endl;
    return 5;
  }
