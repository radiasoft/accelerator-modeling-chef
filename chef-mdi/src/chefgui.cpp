...
CHEFGUIBase(parent,name,f), _plotWidget(0), _DspnplotWidget(0), _ETplotWidget(0), 
                           _LBplotWidget(0), _MMplotWidget(0), _p_vwr(0)
 ...
 if( 0 == _p_currBmlCon ) {
  ...
  if( lfd ) {
    ...
    { 
       ...
       _plotWidget->show();    
       connect( _plotWidget, SIGNAL(QObject::destroyed(QObject*)), 
                       this, SLOT  (_invalidatePlotWidget(QObject*)) );
...
void CHEFGUI::_launchLB()
{
  ...
  if( lbfd ) {
    if (!_LBplotWidget)
    {
       ...
       _LBplotWidget->show();
       connect(_LBplotWidget, SIGNAL(QObject::destroyed(QObject*)), 
                        this, SLOT  (_invalidatePlotWidget(QObject*)) );
    };
...
CHEFGUI::_launchET()
{
  ...
  if( etfd ) {
    if (!_ETplotWidget)
    {
     ...
     _ETplotWidget->show();
       connect( _ETplotWidget, SIGNAL(QObject::destroyed(QObject*)), 
                         this, SLOT  (_invalidatePlotWidget(QObject*)) );
    };
...
CHEFGUI::_launchMoments()
{
  ...
  if( mfd ) {
    if (!_MMplotWidget)
    {
      ...
      _MMplotWidget->show();
       connect( _MMplotWidget, SIGNAL(QObject::destroyed(QObject*)), 
                         this, SLOT  (_invalidatePlotWidget(QObject*)) );      
   };
  ...
  if( QDialog::Accepted == _initCondDialogDisp->exec() ){
    ...
    if(dfd) {
      if (!_DspnplotWidget)
      {
         ...
         connect(  _DspnplotWidget, SIGNAL(QObject::destroyed(QObject*)), 
                              this, SLOT  (_invalidatePlotWidget(QObject*)) );
      };
