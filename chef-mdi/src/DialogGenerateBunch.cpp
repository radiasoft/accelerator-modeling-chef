...
DialogGenerateBunch::DialogGenerateBunch(QWidget* parent, const char* name, WFlags f)
 : DialogGenerateBunchBase(parent,name,f)
{
#if 0
...
void DialogGenerateBunch::readInputValues()
{
#if 0
...
DialogGenerateBunch::getInitCond()
{
  readInputValues();
  return lf_;
}
...
void
DialogGenerateBunch:: setInitCond(const LattFuncSage::lattFunc& lf) 
{
...
void 
DialogGenerateBunch::dispersionMode()
{
...
void 
DialogGenerateBunch::momentsMode()
{
